...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  // =======================================================================
  // TODO: Your code here!
  // loop through the pointers of edges
  for (const auto& p2 : originalNeighbors) {
    // if there is an edge erase both pointers to edge form the respective key.
    if (hasEdge(p1,p2)) {
